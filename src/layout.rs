...
pub(crate) struct Layout {
    ...
    pub(crate) default_settings: HashMap<String, String>,
...
pub(crate) fn render<'a, W: std::fmt::Write, T: std::fmt::Display, S: std::fmt::Display>(
    mut w: W,
    layout: &Layout,
    page: &Page<'_>,
    sidebar: S,
...
<body class=\"rustdoc {css_class}\">\
    ...
    <script defer src=\"{root_path}search-index{suffix}.js\"></script>\
        ...
        logo = {
            ...
            let p = crate::format::ensure_trailing_slash(&p);
...
<link rel="alternate icon" type="image/png" href="{static_root_path}favicon-32x32{suffix}.png">"##,
        ...
        style_files = style_files
            ...
            .map(|t| format!(
                ...
                Escape(&format!(
                    "{}{}{}",
                    static_root_path, t.0, page.resource_suffix
                )),
